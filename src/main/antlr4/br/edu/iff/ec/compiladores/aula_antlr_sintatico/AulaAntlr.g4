...
UNIDADE: 'MIR'|'MT'|'MCM'|'MAP'|'MHAERJ'|'COV'|'CCA'|'CEC';
TIPO_OBJETO: 'PINTURA' | 'ESCULTURA' | 'GRAVURA' | 'FOTOGRAFIA' | 'ARTEFATOS_ARQUEOLOGICOS' | 'ESCULTURA_EM_RELEVO' | 'INSTALACAO' | 'ARTE_TEXTIL' | 'MOBILIARIO' | 'DOCUMENTO'  | 'ARTEFATO_ETNOGRAFICO' | 'MOEDA' | 'MEDALHA' | 'INSTRUMENTO_MUSICAL' | 'GEMA' | 'JOIA' | 'EQUIPAMENTO_CIENTIFICO' | 'ARQUITETURA_EM_MINIATURA' | 'VEICULO';
...
UNIDADE_ACERVO: 'MIR'|'MT'|'MCM'|'MAP'|'MHAERJ'|'COV'|'CCA'|'CEC';
OBJETO: 'PINTURA' | 'ESCULTURA' | 'GRAVURA' | 'FOTOGRAFIA' | 'ARTEFATOS_ARQUEOLOGICOS' | 'ESCULTURA_EM_RELEVO' | 'INSTALACAO' | 'ARTE_TEXTIL' | 'MOBILIARIO' | 'DOCUMENTO'  | 'ARTEFATO_ETNOGRAFICO' | 'MOEDA' | 'MEDALHA' | 'INSTRUMENTO_MUSICAL' | 'GEMA' | 'JOIA' | 'EQUIPAMENTO_CIENTIFICO' | 'ARQUITETURA_EM_MINIATURA' | 'VEICULO';
